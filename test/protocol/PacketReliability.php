...
abstract class PacketReliability{
 ...
 public static function isReliable(int $reliability) : bool{
  return in_array($reliability, [self::RELIABLE, self::RELIABLE_ORDERED, self::RELIABLE_SEQUENCED, self::RELIABLE_WITH_ACK_RECEIPT, self::RELIABLE_ORDERED_WITH_ACK_RECEIPT]);
 }
 public static function isSequenced(int $reliability) : bool{
  return in_array($reliability, [self::UNRELIABLE_SEQUENCED, self::RELIABLE_SEQUENCED]);
 }
 public static function isOrdered(int $reliability) : bool{
  return in_array($reliability, [self::RELIABLE_ORDERED, self::RELIABLE_ORDERED_WITH_ACK_RECEIPT]);
 }
 public static function isSequencedOrOrdered(int $reliability) : bool{
  return in_array($reliability, [self::UNRELIABLE_SEQUENCED, self::RELIABLE_ORDERED, self::RELIABLE_SEQUENCED, self::RELIABLE_ORDERED_WITH_ACK_RECEIPT]);
 }
}
